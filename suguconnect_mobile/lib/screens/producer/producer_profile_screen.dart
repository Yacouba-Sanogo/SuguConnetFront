        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(Icons.inventory_2, 'Produits', false),
              _buildNavItem(Icons.receipt_long, 'Commandes', false),
    ...
    return GestureDetector(
      onTap: () {
        ...
        if (label == 'Accueil') {
          ...
          Navigator.pushNamed(context, '/producer/products');
        } else if (label == 'Commandes') {
          Navigator.pushNamed(context, '/producer/orders');
        }
      },
      child: Column(
        ...
        children: [
          Icon(
            icon,
            color: isActive ? const Color(0xFFFB662F) : Colors.grey,
            size: 24,
          ),
