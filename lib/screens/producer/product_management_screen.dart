...
class _ProductManagementScreenState extends State<ProductManagementScreen> {
  ...
  // Charge une image réseau en normalisant l'hôte avec la base API et en joignant le token si nécessaire
  static Future<Widget> loadNetworkImageWithAuth(BuildContext context, String url) async {
    try {
  ...
  static Widget buildImageWidget(BuildContext context, String? imageUrl) {
    if (imageUrl == null || imageUrl.isEmpty) {
      return const Icon(Icons.image, color: Colors.grey);
    }
    if (imageUrl.startsWith('/')) {
      return FutureBuilder<Widget>(
        future: loadNetworkImageWithAuth(context, imageUrl),
        builder: (context, snapshot) {
          ...
          return snapshot.data ?? const Icon(Icons.broken_image, color: Colors.grey);
        },
      );
    }
              ...
              return _ModernProductCard(
                ...
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => ProducerProductDetailScreen(
                        product: _products[index],
                      ),
                    ),
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Supprimer', style: GoogleFonts.itim(color: Colors.red)),
          ),
        ],
      ),
    );
              ...
              children: [
                ...
                Container(
                  ...
                  child: product.imageUrl != null
                      ? ClipRRect(
                          borderRadius: BorderRadius.circular(8),
                          child: _ProductManagementScreenState.buildImageWidget(context, product.imageUrl),
                        )
                    ...
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Modifier', style: GoogleFonts.itim()),
                        ],
                      ),
                    ),
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Supprimer', style: GoogleFonts.itim(color: Colors.red)),
                        ],
                      ),
                    ),
                  ],
