...
Commande _$CommandeFromJson(Map<String, dynamic> json) => Commande(
  ...
  remboursement: json['remboursement'] == null
      ? null
      : Remboursement.fromJson(json['remboursement'] as Map<String, dynamic>),
);
...
Map<String, dynamic> _$CommandeToJson(Commande instance) => <String, dynamic>{
  ...
  'detailsCommande': instance.detailsCommande.map((e) => e.toJson()).toList(),
  'paiement': instance.paiement?.toJson(),
  'livraison': instance.livraison?.toJson(),
  'remboursement': instance.remboursement?.toJson(),
};
...
Map<String, dynamic> _$DetailCommandeToJson(DetailCommande instance) =>
    <String, dynamic>{
      ...
      'produit': instance.produit.toJson(),
      'commande': instance.commande.toJson(),
    };
